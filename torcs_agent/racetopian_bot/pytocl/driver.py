...
# TODO Create your own Driver class
class Driver:
    """
    Driving logic.
    ...
    def __init__(self, logdata=True):
        self.steering_ctrl = CompositeController(
            ...
            # ProportionalController(0.48),
            # IntegrationController(0.24, integral_limit=1.5),
            # DerivativeController(2.4)
    ...
    def accelerate(self, carstate, target_speed, command):
        ...
        # print(speed_mps)
        # if command.gear < 5 and carstate.rpm > 9500:
        #     command.gear = command.gear + 1
        # elif command.gear == 2 and carstate.rpm < 4013:
        #     command.gear = 1
        # elif command.gear == 3 and carstate.rpm < 6313:
        #     command.gear = 2
        # elif command.gear == 4 and carstate.rpm < 7018:
        #     command.gear = 3
        # elif command.gear == 5 and carstate.rpm < 7430:
        #     command.gear = 4
        # elif command.gear == 6 and carstate.rpm < 7483:
        #     command.gear = 5
